...
from oos.views import get_child, get_work, get_user, post_work, post_price, post_pic, get_works, get_prices, get_BC, provider_works, get_keys_for_cat, get_cats, get_values, post_item, del_work, get_old_works, old_provider_works, get_all_works
admin.autodiscover()
...
urlpatterns = patterns('',
	...
	(r'^oos/get_all_works/$', get_all_works),
